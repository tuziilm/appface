...
<div id="search">
    <form id="search_form" action="${basePath}link_node_access_log_statistics/chart" method="post"
        ...
        <label>开始时间:</label>
        <input value="${appface:defVal(param.startTime,appface:dateStringAboutNow("yyyy/MM/dd", -30))}" type="text"
               name="startTime" class="input-small" id="startTime"/>
        <label>截止时间:</label>
        <input value="${appface:defVal(param.endTime,appface:yesterdayString("yyyy/MM/dd"))}" type="text" name="endTime"
